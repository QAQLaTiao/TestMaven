package com.guoy.btdownlod.model.main;

import com.guoy.btdownlod.model.BitTorrentInfo;
import com.guoy.btdownlod.model.Files;
import com.guoy.btdownlod.model.Info;
import com.guoy.util.DateUtil;
...
public class BitTorrents {
    ...
    public static void main(String[] args) throws Exception {
        BitTorrentInfo info = parse("E://HBAD-339.torrent");
        System.out.println("信息:" + info.getAnnounce() + "\t" + info.getComment() + "\t" + info.getCreateBy() + "\t" + DateUtil.getDateTime(info.getCreationDate()));
